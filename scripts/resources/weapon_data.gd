...
func _init(weapon_type_: Data.WeaponType, player_projectile_type_: Data.PlayerProjectileType, fire_range_: int, damage_: float, cooldown_duration_: float, name_: String, ui_icon_: Texture2D) -> void:
